...
SPAM.class_list["Chierico"].buff.tank = {"cure leggere continue"}
...
SPAM.class_list["Paladino"].buff.tank = {"cure leggere continue"}
...
SPAM.class_list["Mago"].self_buff.base = {"percepisci magico", "scudo infuocato"}
